...
|fmsub.d   f1, f2, f3, f4 |Fused Multiply Subtract (64 bit): Assigns f2*f3-f4 to f1|
|fmsub.s   f1, f2, f3, f4 |Fused Multiply Subtract: Assigns f2*f3-f4 to f1|
...
|fnmsub.d  f1, f2, f3, f4 |Fused Negated Multiply Subtract (64 bit): Assigns -(f2*f3-f4) to f1|
|fnmsub.s  f1, f2, f3, f4 |Fused Negated Multiply Subtract: Assigns -(f2*f3-f4) to f1|
